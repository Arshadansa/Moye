...
function Supply() {
  ...
  return (
    <div className="w-full  md:my-12">
      <div className="max-w-screen-xl flex flex-col flex-wrap bg-gradient-to-b from-black to-blue-900 storyText mx-auto">
        ...
        <div className="w-full flex flex-wrap items-center gap-16 justify-center pb-5 md:p-5">
          <div className="lg:w-96 w-80  bg-opacity-50 bg-black p-4 rounded-lg">
